...
public class Project_Hazard {
     ...
     * @param hzLng
     */
    public Project_Hazard(String hzLocation, String hzRpt, String hzType, String hzDesc, String hzTime, String hzDate, String hzLtd, String hzLng) {
        super();
